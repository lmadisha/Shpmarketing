...
<template>
  <div
    class="flex min-h-screen items-center justify-center bg-slate-100 px-4 py-8"
  >
      ...
      <div class="p-8">
        ...
        <form class="mt-6 space-y-4" @submit.prevent="handleSubmit">
          ...
          <div class="grid gap-4 md:grid-cols-2">
            ...
            <div class="space-y-2">
              ...
              <Select
                ...
                :options="
                  USER_PERMISSION_LEVELS.map((p) => ({ value: p, label: p }))
                "
              />
            </div>
          </div>
          <div class="space-y-2">
            ...
            <Select
              ...
              :options="[
                {
                  value: '',
                  label: organisationsLoading
                    ? 'Loading organisations...'
                    : 'Select organisation',
                },
                ...organisations.map((o) => ({
                  value: String(o.id),
                  label: o.name + (o.domin ? ` (${o.domin})` : ''),
                })),
              ]"
            />
          </div>
          ...
          <p class="text-center text-sm text-slate-600">
            ...
            <NuxtLink
              to="/login"
              class="font-medium text-[#006aea] hover:underline"
              >Sign in</NuxtLink
            >
          </p>
        </form>
